document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- MAQUINA DE ESCRIBIR ---
    const welcomeMsg = "You are my love for another life, my love for another occasion. You arrived too soon and yet it was late. You understood me more than anyone, and there was no one who loved you more than I did. I have always believed that everything is possible and that the impossible... just takes a little longer. But dear impossible love, with you that theory is unnecessary. Sometimes I feel that we were untimely, or that destiny was so stubborn with us... that it decided to put us one minute late. Maybe one person before or one person after, we were everything and we were nothing.";
